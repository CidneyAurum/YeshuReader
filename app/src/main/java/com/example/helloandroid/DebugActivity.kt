        ...
        try {
            ...
            when (action) {
                "setapi" -> {
                    ...
                    db.setSetting("ai_key", intent.getStringExtra("key") ?: "")
                    ...
                    Thread {
                        ...
                        try {
                            ...
                            out.append("SUMMARY_OK ms=").append(System.currentTimeMillis() - t0)
                                .append(" notes_saved=true\n回复: ").append(reply.take(200))
                        } catch (t: Throwable) {
                ...
                "vsum" -> {
                    ...
                    if (fmt == "pdf") {
                        ...
                        doc.blocks.take(6).forEach { b ->
                            log.append('[').append(if (b.type == Block.HEADING) "H" else "P").append("] ")
                                .append(b.text.take(80)).append('\n')
                        }
                    }
                }
            }
