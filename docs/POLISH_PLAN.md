...
已完成：R1 R2 R3 R4 R5 R6 R8 R9 R10 R11 R14 R15 R16 R18 R20 R21 R22 R24 R27 R30 R34 R37 R45 R48，
以及附带修复 F1 F2 F3 F4。
部分完成：R12（已有命中计数与列表跳转，未做上一处/下一处）、R35（已有当前章 ◀ 标记，未做每章百分比）、
R49/R50（AI 菜单与段落菜单已全部换成线性图标，其余页面的 emoji 与零散字号仍待扫）。
未完成（本轮时间不足，计划保留）：R7 R13 R17 R19 R23 R25 R26 R28 R29 R31 R32 R33 R36 R38 R39 R40 R41 R42 R43 R44 R46 R47。
